...
RSpec.describe RsvpsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested rsvp as @rsvp" do
      rsvp = Rsvp.create! valid_attributes
      get :show, params: {id: rsvp.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested rsvp as @rsvp" do
      rsvp = Rsvp.create! valid_attributes
      get :edit, params: {id: rsvp.to_param}, session: valid_session
      expect(assigns(:rsvp)).to eq(rsvp)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Rsvp" do
        expect {
          post :create, params: {rsvp: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved rsvp as @rsvp" do
        post :create, params: {rsvp: invalid_attributes}, session: valid_session
        expect(assigns(:rsvp)).to be_a_new(Rsvp)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested rsvp" do
        rsvp = Rsvp.create! valid_attributes
        put :update, params: {id: rsvp.to_param, rsvp: new_attributes}, session: valid_session
        rsvp.reload
      ...
      it "assigns the requested rsvp as @rsvp" do
        rsvp = Rsvp.create! valid_attributes
        put :update, params: {id: rsvp.to_param, rsvp: valid_attributes}, session: valid_session
        expect(assigns(:rsvp)).to eq(rsvp)
      end
    ...
    context "with invalid params" do
      it "assigns the rsvp as @rsvp" do
        rsvp = Rsvp.create! valid_attributes
        put :update, params: {id: rsvp.to_param, rsvp: invalid_attributes}, session: valid_session
        expect(assigns(:rsvp)).to eq(rsvp)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested rsvp" do
      rsvp = Rsvp.create! valid_attributes
      expect {
        delete :destroy, params: {id: rsvp.to_param}, session: valid_session
      }.to change(Rsvp, :count).by(-1)
    end
